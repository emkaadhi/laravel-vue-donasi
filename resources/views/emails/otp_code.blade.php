                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top"
                                ...
                                <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome! {{ $user->name }}
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B"><a
                                                            href="#" target="_blank"
                                                            style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #FFA73B; display: inline-block;">{{ $user->otp_code->otp }}</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                                ...
                                <p style="margin: 0;">Cheers,<br>Crowfunding Team</p>
                            </td>
                        </tr>
                    </table>
                </td>
